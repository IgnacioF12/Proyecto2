...
public abstract class SimpleProcess {
    ...
    /** El campo id es un entero que identifica al proceso, los ids son correlativos por política **/
    protected int id;
     ...
     * @param tiempoRestante representa el tiempo que el proceso necesita para completar su ejecución
     */
    ...
    /**
     * Método abstracto para ejecutar el proceso. Cada subclase debe definir cómo se ejecuta el proceso.
     ...
     * @return devuelve un String de la forma [id:id_del_proceso, tiempoRestante:tiempo]
     */
    @Override
